    ...
    //     this.fncOnTimer = setTimeout(this.play_once, 1000 / this.fps);
    // }
    // this.stop = function() {
    //     clearTimeout(this.fncOnTimer);
    // }

    // this.play_once = function() {
    //     this.x = this.x + this.step;

    //     console.log(this.x);
    //     console.log(this.element);

    //     this.element.css('background-position', this.x + '% 0');
    //     this.play_step();

    //     if (this.x >= 100) { this.stop(); }
