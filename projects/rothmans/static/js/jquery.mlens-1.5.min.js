...
function cigarettes() {
	...
	$(".expert .cigarette.n3 img").mlens({
		imgSrc: $(".expert .cigarette.n3 img").attr("data-big"),	    // path of the hi-res version of the image
		//imgSrc2x:$(".expert .cigarette.n3 img").attr("data-big2x"),  // path of the hi-res @2x version of the image
		lensShape: "circle",				// shape of the lens (circle/square)
		lensSize: 240,					// size of the lens (in px)
		borderSize: 13,					// size of the lens border (in px)
		zoomLevel: 0.95                                  // zoom level multiplicator (number)
	...
	$(".expert .cigarette.n4 img").mlens({
		imgSrc: $(".expert .cigarette.n4 img").attr("data-big"),	    // path of the hi-res version of the image
		//imgSrc2x:$(".expert .cigarette.n4 img").attr("data-big2x"),  // path of the hi-res @2x version of the image
		lensShape: "circle",				// shape of the lens (circle/square)
		lensSize: 240,					// size of the lens (in px)
		borderSize: 13,					// size of the lens border (in px)
		zoomLevel: 0.95                                  // zoom level multiplicator (number)
...
function getSizes() {
	$(".expert .cigarette").each(function() { 
    	needSize = $(this).find('img').width();
    	$(this).find("div[id^='mlens_wrapper']").width(needSize);
	});
}

$('.cigarette').on({ 'touchstart' : function(){
	$(this).find('.plus').hide();
 } });

$('.cigarette').on({ 'touchend' : function(){
	$(this).find('.plus').show();
 } });
